...
class Formats extends Component {
    ...
    handleCreate = () => {
        ...
        var canCreate = this.props.SocketIO.formats.formats.every(z => {
        ...
        return (
            <React.Fragment>
                ...
                <Grid container spacing={ 16 }>
                    ...
                    { SocketIO.formats.formats.filter(z => {
                        return z.name.toLowerCase().includes(SocketIO.formats.searchTerm.toLowerCase())
                    }).map((thematic, i) => (
